...
@Composable
fun ZIndexOfDriveContentArea(tutorialStep: DriveTutorialStep, content: @Composable (DriveContentZIndex, Boolean) -> Unit){
...
@Composable
fun ActiveOfFloatBtnArea(tutorialStep: DriveTutorialStep, content: @Composable (FloatBtnActive) -> Unit){
