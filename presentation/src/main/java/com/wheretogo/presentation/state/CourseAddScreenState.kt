...
data class CourseAddScreenState(
    ...
    val duration : Int = 0,
    val markerLatlngGroup: List<Marker> = emptyList(),
    ...
    val detailItemStateGroup: List<RouteDetailItemState> = getRouteDetailItemGroup().map { RouteDetailItemState(data = it) },
